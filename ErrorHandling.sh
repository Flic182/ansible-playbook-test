...
readonly CONTROL_DIR="${WORKING_DIR}/build/ansible-control"
readonly PLAYBOOK_COPY="${CONTROL_DIR}/playbook"
...
################################################################################
# Removes the copy of the playbook in the build directory.
################################################################################
